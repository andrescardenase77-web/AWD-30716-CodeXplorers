<template>
  <div class="admin-view">
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3 mb-4">
      ...
      <RouterLink :to="{ name: 'payment-register' }" class="btn-primary-gradient w-100 w-md-auto text-center flex-shrink-0">
    ...
    <div class="card-surface p-0 overflow-hidden">
      ...
      <div v-else-if="payments.length === 0" class="text-center py-5 px-3">
        ...
        <RouterLink :to="{ name: 'payment-register' }" class="btn-primary-gradient mt-2">
          <i class="bi bi-plus-lg"></i> Registrar Pago
        </RouterLink>
      </div>
