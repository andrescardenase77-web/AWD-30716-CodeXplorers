...
const navigationLinks = [
  {
    ...
    icon: '<svg width="18" height="18" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/></svg>'
  },
  {
    name: 'inventory',
    label: 'Catálogo de Inventario',
    route: '/admin/inventory',
    icon: '<svg width="18" height="18" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/></svg>'
  },
  {
    name: 'supply-register',
    label: 'Registrar Insumo',
    route: '/admin/supply-register',
  ...
  },
  {
    ...
    icon: '<svg width="18" height="18" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M12 4v1m-8 8H4m16-4h1.414M16 12a4 4 0 11-8 0 4 4 0 018 0zM4 16h.01M20 16h.01M4 8h.01M20 8h.01"/></svg>'
  },
  {
    name: 'restock-budget',
    label: 'Presupuesto de Compra',
    route: '/admin/restock-budget',
    icon: '<svg width="18" height="18" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>'
  },
  {
    name: 'expiration-alerts',
    label: 'Alertas de Caducidad',
    route: '/admin/expiration-alerts',
    icon: '<svg width="18" height="18" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"/></svg>'
  },
  {
    name: 'expired-history',
    label: 'Historial de Productos Expirados',
    route: '/admin/expired-history',
  ...
  {
    name: 'loss-analysis',
    label: 'Análisis de Pérdidas',
    route: '/admin/loss-analysis',
